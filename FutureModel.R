...
#Julian Day stuff to possibly add day of year (DOY) as a stand-in for LAI
#unused so far
...
plot(time,ci2[2,],type='n',ylim=range(y,na.rm=TRUE),ylab="NEE (with drivers)",xlim=time[time.rng])
